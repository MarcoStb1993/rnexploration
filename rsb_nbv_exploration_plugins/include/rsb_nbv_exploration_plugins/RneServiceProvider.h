...
#ifndef RRG_NBV_EXPLORATION_PLUGINS_SRC_RNESERVICEPROVIDER_H_
#define RRG_NBV_EXPLORATION_PLUGINS_SRC_RNESERVICEPROVIDER_H_
...
private:
	...
	void explorationGoalObsoleteCallback(
			const rsb_nbv_exploration_msgs::ExplorationGoalObsolete::ConstPtr &best_goal);
...
#endif /* RRG_NBV_EXPLORATION_PLUGINS_SRC_RNESERVICEPROVIDER_H_ */
