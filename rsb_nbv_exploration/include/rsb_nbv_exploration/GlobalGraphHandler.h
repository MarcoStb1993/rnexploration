...
public:
	 ...
	 */
	void initialize(rsb_nbv_exploration_msgs::Node &root,
	 ...
	 */
	void addFrontier(int node, rsb_nbv_exploration_msgs::Graph &rrg);
	 ...
	 * @param Reference to the RRG
	 */
	void continuePath(int node, rsb_nbv_exploration_msgs::Graph &rrg);
	 ...
	 */
	void deactivateFrontiersInLocalGraph(rsb_nbv_exploration_msgs::Graph &rrg,
	 ...
	 */
	bool calculateNextFrontierGoal(rsb_nbv_exploration_msgs::Graph &rrg);
...
private:
	 ...
	 */
	rsb_nbv_exploration_msgs::GlobalGraph _gg;
	/**
	 ...
	 */
	bool getConnectingNode(int node, rsb_nbv_exploration_msgs::Graph &rrg,
	...
	void buildMissingPathBetweenFrontiers(
			...
			std::vector<int> &local_connection, rsb_nbv_exploration_msgs::Graph &rrg);
