...
#include "../../../rsb_nbv_exploration/include/rsb_nbv_exploration/ShortestFrontierConnectionStruct.h"
...
public:
	 ...
	 */
	void initializePathToRobot(rsb_nbv_exploration_msgs::Node &node,
	 ...
	 */
	void updatePathsToRobot(int startNode, rsb_nbv_exploration_msgs::Graph &rrg,
	 ...
	 */
	bool neighbourNodes(rsb_nbv_exploration_msgs::Graph &rrg, int startNode,
			int endNode);
	 ...
	 */
	int determineGoalYaw(int current_goal, rsb_nbv_exploration_msgs::Graph &rrg,
	 ...
	 */
	double calculateCostFunction(rsb_nbv_exploration_msgs::Node &node);
	 ...
	 */
	int calculateHeadingChangeToBestView(rsb_nbv_exploration_msgs::Node &node);
	 ...
	 */
	int findExistingEdge(rsb_nbv_exploration_msgs::Graph &rrg, int node,
			int neighbor_node);
	 ...
	 */
	std::map<int, int> findShortestRoutes(rsb_nbv_exploration_msgs::Graph &rrg,
	 ...
	 * the robot
	 */
	void findPathToNearestNodeThroughFailedNodes(
...
private:
	...
	bool getHeadingBetweenNodes(int start_node, int end_node, int &yaw,
			double &distance, rsb_nbv_exploration_msgs::Graph &rrg);
	 ...
	 */
	rsb_nbv_exploration_msgs::Node calculateCostFunctionForConnection(
