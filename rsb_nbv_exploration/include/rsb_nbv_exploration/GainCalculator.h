...
public:
	 ...
	 */
	void calculateGain(rsb_nbv_exploration_msgs::Node &node);
...
private:
	 ...
	 */
	rsb_nbv_exploration_msgs::Node _last_updated_node;
	/**
	 ...
	 * @param Node which gain needs to be calculated
	 */
	void calculatePointGain(rsb_nbv_exploration_msgs::Node &node);
	 ...
	 */
	bool measureNodeHeight(rsb_nbv_exploration_msgs::Node &node);
